...
var sink1Component = new Component('sink1', 'unique-id-2', 11, 21, 'entity', [validPort3, validPort4]);
var sink2Component = new Component('sink2', 'unique-id-3', 12, 22, 'entity', [validPort5, validPort6]);
