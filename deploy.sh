...
SOURCE_BRANCH="MichaelJBradley/travis-docs"
...
openssl aes-256-cbc -K $ENCRYPTED_KEY_VAR -iv $ENCRYPTED_IV_VAR -in ../gh-pages-deploy-key.enc -out ../gh-pages-deploy-key -d
